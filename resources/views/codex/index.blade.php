            ...
            <div class="mt-4">
                ...
                <div x-show="activePillar === 'health'" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 translate-y-2" x-transition:enter-end="opacity-100 translate-y-0"
                    ...
                    <x-p class="text-slate-300">
                        <span class="text-emerald-400 font-semibold">«Здоровье — это твой главный капитал»</span>. Тело, питание, сон. Выражай эмоции без накопления обид, не стесняйся просить помощь и читай каждый день.
                    </x-p>
                    ...
                    <div class="space-y-2 pt-1">
                        ...
                        <div class="rounded-xl border border-slate-800/60 overflow-hidden">
                            ...
                            <div x-show="openSub === 'physical'" x-collapse>
                                <div class="p-3 bg-slate-950/30 border-t border-slate-800/40 grid grid-cols-1 sm:grid-cols-2 gap-2 text-[11px] font-sans text-slate-300">
                                    <div class="bg-slate-900/50 p-2.5 rounded-lg border border-emerald-500/5"><strong>🏃‍♂️ Физическая активность:</strong> Регулярные тренировки и кардио для тонуса тела.</div>
                                    <div class="bg-slate-900/50 p-2.5 rounded-lg border border-emerald-500/5"><strong>🚭 Без вредных привычек:</strong> Отказ от разрушающих тело веществ.</div>
                                    <div class="bg-slate-900/50 p-2.5 rounded-lg border border-emerald-500/5 sm:col-span-2"><strong>🩺 Профилактика:</strong> Регулярная профилактика и медицинские осмотры лучше, быстрее и дешевле лечения.</div>
                                    <div class="bg-slate-900/50 p-2.5 rounded-lg border border-emerald-500/5"><strong>🚿 Гигиена:</strong> Душ каждый день, дезодорант — обязательно. Чистые ногти, зубы 2 раза в день, уход за кожей.</div>
                                    <div class="bg-slate-900/50 p-2.5 rounded-lg border border-emerald-500/5"><strong>💇‍♂️ Уход за собой:</strong> Стрижка каждые 3–4 недели. Аккуратный внешний вид.</div>
                                    <div class="bg-slate-900/50 p-2.5 rounded-lg border border-emerald-500/5 sm:col-span-2"><strong>🧍‍♂️ Осанка & Позвоночник:</strong> Плечи назад, грудь вперёд, подбородок параллельно полу. Стой у стены 2 мин/день (затылок, лопатки, ягодицы, пятки).</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="rounded-xl border border-slate-800/60 overflow-hidden">
                            <button type="button" @click="openSub = openSub === 'nutrition' ? '' : 'nutrition'" class="w-full flex items-center justify-between px-3.5 py-2.5 text-left text-[11px] font-black uppercase tracking-wider transition-colors duration-200" :class="openSub === 'nutrition' ? 'bg-emerald-500/10 text-emerald-400' : 'bg-slate-950/40 text-slate-400 hover:text-slate-200'">
                                <span>🥗 Правила Питания & Диеты</span>
                                <span class="text-[9px] transition-transform duration-200" :class="openSub === 'nutrition' && 'rotate-180'">▼</span>
                            </button>
                            <div x-show="openSub === 'nutrition'" x-collapse>
                                <div class="p-3 bg-slate-950/30 border-t border-slate-800/40 space-y-3 text-[11px] font-sans text-slate-300">


                                    <div class="bg-slate-900/50 p-3 rounded-lg border border-emerald-500/10">
                                        <span class="text-[10px] font-black text-emerald-400 uppercase tracking-wider block mb-1">🥩 Правило Тарелки (без подсчета КБЖУ)</span>
                                        <ul class="list-disc pl-4 space-y-1 text-slate-400">
                                            <li><strong>½ тарелки — БЕЛОК</strong> (куриное филе, говядина, индейка, белая/красная рыба, яйца, творог)</li>
                                            <li><strong>¼ тарелки — СВЕЖИЕ ОВОЩИ</strong> (огурцы, помидоры, зелень, брокколи, капуста в любом объеме)</li>
                                            <li><strong>¼ тарелки — СЛОЖНЫЕ УГЛЕВОДЫ</strong> (гречка, бурый рис, овсянка длительной варки, печеный картофель)</li>
                                            <li><strong>+ Полезные жиры</strong> (нерафинированные масла, горсть орехов, авокадо)</li>
                                        </ul>
                                    </div>

                                    <div class="bg-slate-900/50 p-3 rounded-lg border border-emerald-500/10">
                                        <span class="text-[10px] font-black text-emerald-400 uppercase tracking-wider block mb-1">💡 Белок — Твой Главный Щит</span>
                                        <p class="text-slate-400">Белок защищает твои мышечные волокна от разрушения при похудении. Без него тело будет жечь мышцы вместо жира! Суточная цель: около 1.8–2 г белка на 1 кг веса тела (~30–40 г чистого протеина или порция размером с ладонь в каждый прием пищи).</p>
                                    </div>

                                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-2">
                                        <div class="bg-slate-900/50 p-2.5 rounded-lg border border-emerald-500/5">
                                            <span class="text-[10px] font-black text-emerald-400 uppercase tracking-wider block mb-1">✅ ЧТО ЕСТЬ МОЖНО</span>
                                            <span class="text-slate-400">Курица, индейка, говядина, любая рыба и яйца, гречка, рис, овсянка, творог 5-9%, сыры, овощи без ограничений.</span>
                                        </div>
                                        <div class="bg-slate-900/50 p-2.5 rounded-lg border border-red-500/5">
                                            <span class="text-[10px] font-black text-red-400 uppercase tracking-wider block mb-1">🚫 ЧЕРНЫЙ СПИСОК</span>
                                            <span class="text-slate-400">Любой алкоголь, выпечка, торты, конфеты, чипсы, фастфуд, сухарики, пакетированные соки, сладкие йогурты и соусы.</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="rounded-xl border border-slate-800/60 overflow-hidden">
                            <button type="button" @click="openSub = openSub === 'recovery' ? '' : 'recovery'" class="w-full flex items-center justify-between px-3.5 py-2.5 text-left text-[11px] font-black uppercase tracking-wider transition-colors duration-200" :class="openSub === 'recovery' ? 'bg-emerald-500/10 text-emerald-400' : 'bg-slate-950/40 text-slate-400 hover:text-slate-200'">
                                <span>😴 Восстановление, Сон & Гормоны</span>
                                <span class="text-[9px] transition-transform duration-200" :class="openSub === 'recovery' && 'rotate-180'">▼</span>
                            </button>
                            <div x-show="openSub === 'recovery'" x-collapse>
                                <div class="p-3 bg-slate-950/30 border-t border-slate-800/40 space-y-3 text-[11px] font-sans text-slate-300">
                                    <div class="bg-slate-900/50 p-3 rounded-lg border border-emerald-500/5">
                                        <span class="text-[10px] font-black text-emerald-400 uppercase tracking-wider block mb-1">💤 Гигиена Сна (7–9 часов)</span>
                                        <p class="text-slate-400 mb-1.5">Недосып (меньше 6 часов) снижает уровень тестостерона</p>
                                    ...
                                    <div class="bg-slate-900/50 p-3 rounded-lg border border-emerald-500/5">
                                        <span class="text-[10px] font-black text-emerald-400 uppercase tracking-wider block mb-1">🧘 Управление Стрессом & Кортизол</span>
                                        <p class="text-slate-400 mb-1.5">Кортизол (гормон стресса) — главный враг тестостерона и роста мышц:</p>
                                        <ul class="list-disc pl-4 space-y-0.5 text-slate-400">
                                    ...
                                    <div class="bg-slate-900/50 p-3 rounded-lg border border-emerald-500/5">
                                        <span class="text-[10px] font-black text-emerald-400 uppercase tracking-wider block mb-1">💊 Научно обоснованные добавки</span>
                                        <ul class="space-y-1.5 text-slate-400">
                                            <li><strong class="text-amber-400">⭐ Креатин моногидрат (5 г/день)</strong> — дает +5–10% к силе и выносливости. Самая изученная и эффективная добавка.</li>
                                            <li><strong class="text-emerald-300">⭐ Витамин D3 (2000 МЕ/день)</strong> — критически важен для синтеза тестостерона, особенно осенью и зимой.</li>
                                            <li><strong class="text-emerald-300">⭐ Магний (200–400 мг)</strong> — принимай перед сном. Заметно улучшает качество сна и ускоряет расслабление мышц.</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                ...
                <div x-show="activePillar === 'freedom'" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 translate-y-2" x-transition:enter-end="opacity-100 translate-y-0"
                    ...
                    <x-p class="text-slate-300">
                        <span class="text-violet-400 font-semibold">«Свобода — это возможность не делать то, чего ты делать не хочешь»</span>. Свобода от чужих ожиданий, долгов и навязанного мнения.
                    </x-p>

                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-2 text-[11px] font-sans text-slate-300">
                        <div class="bg-slate-900/50 p-2.5 rounded-lg border border-violet-500/5"><strong>🧠 Критическое мышление:</strong> Никогда не верь слепо. Спрашивай: «Где доказательства? Кому выгодно?»</div>
                        ...
                        <div class="bg-slate-900/50 p-2.5 rounded-lg border border-violet-500/5"><strong>⚖️ Ответственность:</strong> Бери ответственность за свои выборы — они неразделимы со свободой.</div>
                        <div class="bg-slate-900/50 p-2.5 rounded-lg border border-violet-500/5"><strong>🧘‍♂️ Самодостаточность:</strong> Умей быть счастливым наедине с собой. Решай проблемы сам.</div>
                    </div>
                </div>
                ...
                <div x-show="activePillar === 'family'" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 translate-y-2" x-transition:enter-end="opacity-100 translate-y-0"
                    ...
                    <x-p class="text-slate-300">
                        <span class="text-rose-400 font-semibold">«Отношения — это сад, его нужно поливать каждый день»</span>. Избавляйся от токсичных связей, окружай себя донаторами энергии.
                    </x-p>

                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-2 text-[11px] font-sans text-slate-300">
                        <div class="bg-slate-900/50 p-2.5 rounded-lg border border-rose-500/5"><strong>👁️ Зрительный контакт:</strong> Смотри в глаза при разговоре — мягко и уверенно.</div>
                        <div class="bg-slate-900/50 p-2.5 rounded-lg border border-rose-500/5"><strong>⏰ Пунктуальность:</strong> Приходи на 5 мин раньше.</div>
                        <div class="bg-slate-900/50 p-2.5 rounded-lg border border-rose-500/5"><strong>🗣️ Темп речи:</strong> Говори медленнее — быстрая речь = нервозность.</div>
                        <div class="bg-slate-900/50 p-2.5 rounded-lg border border-rose-500/5"><strong>🚫 Без слов-паразитов:</strong> Убери «ну», «типа», «короче», «как бы».</div>
                        <div class="bg-slate-900/50 p-2.5 rounded-lg border border-rose-500/5"><strong>👔 Уверенность:</strong> Не оправдывайся без реальной причины.</div>
                        <div class="bg-slate-900/50 p-2.5 rounded-lg border border-rose-500/5"><strong>🤲 Альтруизм:</strong> Помогай без ожидания ответной выгоды.</div>
                        <div class="bg-slate-900/50 p-2.5 rounded-lg border border-rose-500/5 sm:col-span-2"><strong>🔇 Уважение:</strong> Не перебивай. Не жалуйся. Читай вслух для тренировки дикции.</div>
                    </div>
                </div>
                ...
                <div x-show="activePillar === 'work'" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 translate-y-2" x-transition:enter-end="opacity-100 translate-y-0"
                    ...
                    <x-p class="text-slate-300">
                        <span class="text-amber-400 font-semibold">«+1% каждый день»</span>. Маленькие шаги в ремесле ведут к величию. Фокус на пользе людям и качестве процесса.
                    </x-p>

                    <div class="space-y-2 pt-1">
                        <div class="rounded-xl border border-slate-800/60 overflow-hidden">
                            <button type="button" @click="openSub = openSub === 'discipline' ? '' : 'discipline'" class="w-full flex items-center justify-between px-3.5 py-2.5 text-left text-[11px] font-black uppercase tracking-wider transition-colors duration-200" :class="openSub === 'discipline' ? 'bg-amber-500/10 text-amber-400' : 'bg-slate-950/40 text-slate-400 hover:text-slate-200'">
                                <span>⚔️ Дисциплина & Сила Воли</span>
                                <span class="text-[9px] transition-transform duration-200" :class="openSub === 'discipline' && 'rotate-180'">▼</span>
                            </button>
                            <div x-show="openSub === 'discipline'" x-collapse>
                                <div class="p-3 bg-slate-950/30 border-t border-slate-800/40 space-y-3 text-[11px] font-sans text-slate-300">
                                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-2">
                                        <div class="bg-slate-900/50 p-2.5 rounded-lg border border-amber-500/5"><strong>🛡️ Честность:</strong> Признавай свои ошибки быстро и без оправданий.</div>
                                        <div class="bg-slate-900/50 p-2.5 rounded-lg border border-amber-500/5"><strong>🤐 Принятие:</strong> Не жалуйся — либо решай проблему, либо смирись и прими её.</div>
                                        <div class="bg-slate-900/50 p-2.5 rounded-lg border border-amber-500/5"><strong>🧘‍♂️ Контроль:</strong> Контролируй реакции — ты не владеешь внешним миром, но владеешь собой.</div>
                                        <div class="bg-slate-900/50 p-2.5 rounded-lg border border-amber-500/5 sm:col-span-2"><strong>🧠 Лидерство:</strong> Будь спокоен под давлением — это отличает лидера от толпы.</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="rounded-xl border border-slate-800/60 overflow-hidden">
                            <button type="button" @click="openSub = openSub === 'household' ? '' : 'household'" class="w-full flex items-center justify-between px-3.5 py-2.5 text-left text-[11px] font-black uppercase tracking-wider transition-colors duration-200" :class="openSub === 'household' ? 'bg-amber-500/10 text-amber-400' : 'bg-slate-950/40 text-slate-400 hover:text-slate-200'">
                                <span>🏠 Быт & Порядок в Доме</span>
                                <span class="text-[9px] transition-transform duration-200" :class="openSub === 'household' && 'rotate-180'">▼</span>
                            </button>
                            <div x-show="openSub === 'household'" x-collapse>
                                <div class="p-3 bg-slate-950/30 border-t border-slate-800/40 grid grid-cols-1 sm:grid-cols-2 gap-2 text-[11px] font-sans text-slate-300">
                                    <div class="bg-slate-900/50 p-2.5 rounded-lg border border-amber-500/5"><strong>🛌 Утро:</strong> Заправил кровать каждое утро (30 сек → задаёт тон дня).</div>
                                    <div class="bg-slate-900/50 p-2.5 rounded-lg border border-amber-500/5"><strong>🍽️ Чистота:</strong> Не копи грязную посуду. Мой сразу.</div>
                                    <div class="bg-slate-900/50 p-2.5 rounded-lg border border-amber-500/5"><strong>🌬️ Свежесть:</strong> Регулярно проветривай комнату. Приятный запах дома повышает тонус.</div>
                                    <div class="bg-slate-900/50 p-2.5 rounded-lg border border-amber-500/5 sm:col-span-2"><strong>🍳 Кулинария:</strong> Умей готовить минимум 5 базовых блюд: яичница, паста, рис+мясо, салат, суп.</div>
                                </div>
                            </div>
                        </div>
                    </div>
