                ...
                <div x-show="activePillar === 'family'" x-transition:enter="transition ease-out duration-300"
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-2 text-[11px] font-sans text-slate-300">
                        ...
                        <div class="bg-slate-900/50 p-2.5 rounded-lg border border-rose-500/5 sm:col-span-2"><strong>👨‍👩‍👦
                                Время для близких:</strong> Выделяй фиксированное время в расписании для общения с любимыми, чтобы не откладывать его «на потом».</div>
                        <div class="bg-slate-900/50 p-2.5 rounded-lg border border-rose-500/5 sm:col-span-2"><strong>⚡
                                Внимание и забота:</strong> Общайся с искренним интересом к их жизни. Сопереживай, делись энергией и делай всё с любовью.</div>
                        <div class="bg-slate-900/50 p-2.5 rounded-lg border border-rose-500/5 sm:col-span-2"><strong>🥂
                                Свидания наедине:</strong> Проводи еженедельное свидание с партнером один на один. Задавай вопросы, чтобы обновлять «карту любви» (его заботы, радости и мечты).</div>
                        <div class="bg-slate-900/50 p-2.5 rounded-lg border border-rose-500/5 sm:col-span-2"><strong>🌅
                                Ритуалы общения:</strong> Утром узнавай о планах близкого человека на день. Вечером проводи разговор для снятия дневного стресса и воссоединения.</div>
                        <div class="bg-slate-900/50 p-2.5 rounded-lg border border-rose-500/5 sm:col-span-2"><strong>🫂
                                Тактильность и тепло:</strong> Ежедневно выражай нежность и восхищение. Обнимай, касайся и обязательно целуй перед сном, чтобы сбросить накопившееся раздражение.</div>
                        <div class="bg-slate-900/50 p-2.5 rounded-lg border border-rose-500/5 sm:col-span-2"><strong>🔇
                                Уважение:</strong> Не перебивай. Не жалуйся. Слушай до конца, прежде чем отвечать.</div>
                    </div>
                </div>
