                ...
                <div class="space-y-4">
                    ...
                    <button @click="currentTab = 'goals'" 
                        ...
                        <div class="flex items-center gap-3.5">
                            <span class="text-2xl bg-slate-950/80 w-12 h-12 rounded-xl flex items-center justify-center border border-slate-850/50">🎯</span>
                            <div>
                                <x-h3 class="text-slate-200 group-hover:text-emerald-300 transition-colors">Цели и Накопления</x-h3>
                                <x-p class="text-slate-400 mt-1">Отслеживание прогресса по крупным покупкам и мечтам.</x-p>
                            </div>
                        </div>
                    </button>
                </div>
