        ...
        <template x-if="currentTab === 'hub'">
            <div class="space-y-6">
                ...
                <div class="space-y-4">
                    ...
                    <!-- КНОПКА: КВЕСТЫ -->
                    <button @click="currentTab = 'quests'" 
                            class="w-full bg-slate-900 hover:bg-slate-900/60 border border-slate-900 hover:border-sky-500/20 text-left rounded-2xl p-5 transition-all duration-200 cursor-pointer shadow-lg group relative overflow-hidden block">
                        <div class="absolute -right-6 -top-6 w-16 h-16 bg-sky-500/5 rounded-full blur-xl group-hover:bg-sky-500/10 transition-all"></div>
                        ...
                        <div class="flex items-center gap-3.5">
                            ...
                            <div>
                                <x-h3 class="text-slate-200 group-hover:text-sky-300 transition-colors">Квесты</x-h3>
                                <x-p class="text-slate-400 mt-1">Ежедневные задачи и цели на сегодня.</x-p>
                            </div>
                        </div>
                    </button>
