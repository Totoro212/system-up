<!-- ================= ЭКРАН: КВЕСТЫ ================= -->
<template x-if="currentTab === 'quests'">
    <div class="space-y-6 max-w-2xl mx-auto pb-20" x-data="{
        completedCount: {{ $completedQuests ?? 0 }},
        totalCount: {{ $totalQuests ?? 0 }}
    }">
